...
def sync_gs_report():
    ...
    node_time = get_sync_node_time(task_name='sync_gs_report')
    files = get_fargo_insight_file_basic_not_sync(create_time=node_time[0]['node_time'], source='gs')
    for file in files:
