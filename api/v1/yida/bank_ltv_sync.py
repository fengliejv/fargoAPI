...
from api.v1.yida.yida_config import app_key, app_secret, ltv_form_uuid, user_id, ltv_app_type, \
    ltv_system_token
from api.v1.service.BankService import get_all_bank
from api.v1.service.SymbolService import get_all_symbol
from api.v1.service.BankLtvService import add_bank_ltv, get_all_bank_ltv, update_bank_ltv
...
class SyncBankLtv:
    ...
    def main(
        ...
        try:
                    ...
                    try:
                        ...
                        if dict_key in ltv_dict:
                            ...
                            if bank_ltv == ltv_dict[dict_key]['ltv']:
                                ...
                                res = update_bank_ltv(ltv_id=ltv_dict[dict_key]['uuid'], ltv=bank_ltv)


                        else:

                            res = add_bank_ltv(bank_id=bank_dict[bank]['uuid'], symbol_id=symbol_dict[isin]['uuid'],
                                               ltv=bank_ltv,
            ...
            add_error_log(message=err_msg, source="bank_ltv_sync", e=e)
