...
from service.ResearchService import get_research_need_embedding, set_research_attr
...
def upload_to_dify(DIFY_TOKEN):
    ...
    sql = """
    select * from TB_Research where embedding_status='embedding_ok' where created_time>'2024-09-27 12:00:00' order by create_time offset 0 limit 100
    """
